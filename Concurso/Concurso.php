...
<p><strong>Nome completo: </strong><?php echo $_POST["nomecompleto"] ?></p>
<p><strong>Data de Nacimento: </stong><?php echo $_POST["DataNasc"] ?><p>
<p><strong>Nacionalidade: </stong><?php echo $_POST["nacionalidade"] ?><p>
<p><strong>Sexo: </stong><?php echo $_POST["Sexo"] ?><p>
<p><strong>Número do RG: </stong><?php echo $_POST["RG"] ?><p>
